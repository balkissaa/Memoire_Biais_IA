...
faircvBaseproxyGenderproxy09 = "FairCVtest proxy0.9.npy"
...
fairCV_genderproxy09  = np.load(str(fairCV_path / faircvBaseproxyGenderproxy09), allow_pickle=True).item()


#    Variables utiles  
gender = fairCV_genderproxy09['Gender'].reshape(-1, 1)
blind_labels_test = fairCV_genderproxy09['Blind Labels Test']
scores_biased = fairCV_genderproxy09['Scores']
...
#   Affichage  
print("\n--- Taux de sélection AVANT ROC proxy 0,9 ---")
