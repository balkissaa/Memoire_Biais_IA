...
faircvBaseproxyGenderproxy03 = "FairCVtest proxy0.3.npy"
...
fairCV_genderproxy03  = np.load(str(fairCV_path / faircvBaseproxyGenderproxy03), allow_pickle=True).item()

#   Variables utiles  
gender = fairCV_genderproxy03['Gender'].reshape(-1, 1)
blind_labels_test = fairCV_genderproxy03['Blind Labels Test']
scores_biased = fairCV_genderproxy03['Scores']
...
for seed in range(1, 11):
    ...
    print("\n=== Fairness Metrics APRÈS ROC ===PROXY 0,3")
...
df_results.to_csv(fairCV_path / "FairCV_postprocessing_ROC_10seeds_neutral.csv_proxy_0.3", index=False)
