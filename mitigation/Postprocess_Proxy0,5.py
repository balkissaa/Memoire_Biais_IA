...
faircvBaseproxyGenderproxy05 = "FairCVtest proxy0.5.npy"
...
fairCV_genderproxy05  = np.load(str(fairCV_path / faircvBaseproxyGenderproxy05), allow_pickle=True).item()

#    Variables utiles  
gender = fairCV_genderproxy05['Gender'].reshape(-1, 1)
blind_labels_test = fairCV_genderproxy05['Blind Labels Test']
scores_biased = fairCV_genderproxy05['Scores']
...
#   Affichage  
print("\n--- Taux de sélection AVANT ROC proxy 0,5 ---")
